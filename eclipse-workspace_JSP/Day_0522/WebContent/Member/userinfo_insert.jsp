...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name="form_name" method="post" action="userinfo_insert_pro.jsp">
			...
			<table cellpadding=0 cellspacing=0 border=0 width=650 align=center>       
				<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											...
											<td>
                  		<a href="#" onClick="id_open()"><img src="./img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle></a>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
                  		...
                  		<td>
      								<a href="#" onClick="post_open()"><img src="./img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle></a>
 											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=text name=addr2 size=50 maxlength=100 value="" readonly>
								</td>
							</tr>
							<tr>
