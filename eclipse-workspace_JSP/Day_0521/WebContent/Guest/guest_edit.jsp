     ...
     <form method="post" action="guest_write_pro.jsp" name="input">
      <table border="0">
       <tr>
         ...
         <td width="80%">
         <input type="radio" size="20" name="open" value="1" <%if(open.equals("1")){%>checked <%} %>>공개
         <input type="radio" size="20" name="open" value="2" <%if(open.equals("2")){%>checked <%} %>>비공개
         </td>
       </tr>
              <tr>
         <td width="5%" align="right"><img src="./img/bullet-02.gif"></td>
         ...
         <td width="80%">
         <input type="text" size="20" name="name" value=<%=name %>></td>
       </tr>
              <tr>
         <td width="5%" align="right"><img src="./img/bullet-02.gif"></td>
         <td width="15%"><font size="2 face="돋움"">글종류</font></td>
         <td width="80%">
         <input type="checkbox" size="20" name="kind" value="방문" <%if(kind.contains("방문")){%>checked <%}%>>방문
         <input type="checkbox" size="20" name="kind" value="손님" <%if(kind.contains("손님")){%>checked <%}%> >손님
         <input type="checkbox" size="20" name="kind" value="온라인"<%if(kind.contains("온라인")){%>checked <%}%>>온라인
         </td>
       </tr>
       <tr>
