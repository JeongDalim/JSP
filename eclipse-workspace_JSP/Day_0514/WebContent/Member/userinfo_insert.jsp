...
function userid_check(){
	if(form_name.userid.value==""){
		...
		alert(form_name.userid.value + "는 사용가능한 ID입니다.");
	}
}
		...
		<tr><td align=center><br>                            
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											...
											<td>
                  			<a href="#" onClick="userid_check()"><img src="./img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle></a>
              ...
              <tr>
                <TD BGCOLOR="#EFF4F8">&nbsp;관심분야
                	<font color=red>&nbsp;</font>
								...
								<td bgcolor=WHITE valign=middle> 
									<input type="checkbox" name="fa" value="건강" checked>건강 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                ...
                <a href="#" onClick="insert_check()"><img src="./img/u_bt06.gif" vspace=3 border=0 name=img3></a>
                <a href="#" onClick="insert_reset()"><img src="./img/u_bt05.gif" border=0 hspace=10 vspace=3 name=img4></a>
                </td>
              </tr>
            </table> 
          </td>
