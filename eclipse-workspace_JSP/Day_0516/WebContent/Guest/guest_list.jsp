				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : 10</b>건 - 3 Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<tr onMouseOver="style.backgroundColor='#D1EEEE'"
						...
						<td align="left" height="20"><font face="돋움" size="2"
							color="#000000"> ${subject}</td>
						<td align="center" height="20"><font face="돋움" size="2">
								<a class="list" href="mailto:ein1027@nate.com">${name}</a>
						</font></td>
						<td align="center" height="20"><font face="돋움" size="2">${now}</font></td>
						<td align="center" height="20"><font face="돋움" size="2">0<font></td>
					</tr>
					<!-- ////////////////////////////////////////////////////////////////////////////////////////// -->
					<div align="center">
