...
<c:forEach var="bean" items="${list}" >
        ...
        <font face="돋움" size="2" color="#000000">${cnt}</font></td>
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="board_view.do?num=${bean.num }">${bean.subject }</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">${bean.name }</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">${bean.indate.substring(0,10)}</font></td>
				<td align="center" height="20"><font face="돋움" size="2">
				${bean.readcnt }</font></td>
			</tr>
