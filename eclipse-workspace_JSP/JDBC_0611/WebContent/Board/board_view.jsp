   ...
   <table border="0" width="800">
     <tr>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com">${bean.name }</a> / <font size="2" face="돋움">${bean.indate } / ${bean.readcnt }번 읽음</font>
             <p>
            ${bean.contents }<p><!--contents의 내용을 <BR>태그로 처리-->
           </td>
         </tr>
       </table>
      ...
      <font size="2">
	   ...
	   <!-- 수정하기 -->
       <a href="board_modify.do?num=${bean.num }">
