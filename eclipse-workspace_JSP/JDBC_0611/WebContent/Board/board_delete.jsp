...
function go(){
	...
	location.href="board_delete_pro.do?pass="+my.pass.value;
}
}
 ...
 <form name ="my" method="post" >
   <table border="0" cellpadding="0" cellspacing="0" width="300" align="center">
     ...
     <tr>
      ...
      <a href="#" onClick="go()"><input type="button" value="삭제"></a>
      <a href="board_list.do"> <input type="button" value="닫기"></a></td></tr>
   </table>
   </form>
 </body>
 </html>
