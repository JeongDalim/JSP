...
public class MemberManager {
	...
	public List<MemberBean> list() throws Exception {
	...
	public MemberBean mb(String userid) throws Exception {
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		MemberBean mb = null;
	...
	public MemberBean mb2(String userid, String passwd) throws Exception {
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		MemberBean mb = null;
