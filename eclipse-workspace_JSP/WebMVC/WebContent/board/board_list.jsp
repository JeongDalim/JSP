				...
				<table width="80%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td><table width="100%" border="0" cellpadding="6"
								...
								<c:if test="${!empty list }">
									...
									<c:forEach var="vo" items="${list }">
										<tr>
											...
											<td bgcolor="#FFFFFF"><a
												href="BoardServlet?cmd=board_view&idx=${vo.idx }">${vo.subject }</a></td>
								...
								<c:if test="${empty list }">
									<tr>
										<td bgcolor="#FFFFFF" colspan="5" align="center">등록된 글이 없습니다.</td>
									</tr>
								...
								<form action="BoardServlet?cmd=board_search" method="post"
									name="my">
									<tr>
										<td colspan="10" align="center" bgcolor="#FFFFFF"><table
												...
												<tr>
													...
													<td width=20% align="right"><b><a href="#"
															onClick="search_check()">[검색]</a></b> &nbsp;<a
														href="BoardServlet?cmd=board_write"><b>[글쓰기]</b></a></td>
												</tr>
											</table></td>
									</tr>
								</form>
