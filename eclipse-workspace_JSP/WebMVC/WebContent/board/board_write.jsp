		...
		<tr>
			<td align="center" height="100%" valign=middle><br>
				...
				<form name="my" method="post" action="BoardServlet">
					<input type="hidden" name="cmd" value="board_write_pro">
					<table width="60%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td><table width="100%" border="0" cellpadding="6"
									...
									<tr>
										<td width="20%" align="center" bgcolor="EcECEC"><strong>비밀번호 확인</strong></td>
					...
					<table width="60%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align=center><a href="#" onClick="write_check()"><b>[등록]</b></a>&nbsp;
