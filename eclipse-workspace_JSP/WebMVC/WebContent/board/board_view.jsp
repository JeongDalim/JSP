		...
		<tr>
			<td align="center" height="100%" valign=middle><br>
				...
				<table width="60%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align=center><a
							href="BoardServlet?cmd=board_reply&idx=${vo.idx }"><b>[답변]</b></a>&nbsp;
							<a href="BoardServlet?cmd=board_modify&idx=${vo.idx }"><b>[수정]</b></a>&nbsp;
							<a href="BoardServlet?cmd=board_delete&idx=${vo.idx }"><b>[삭제]</b></a></td>
					</tr>
				</table>
</body>
</html>
