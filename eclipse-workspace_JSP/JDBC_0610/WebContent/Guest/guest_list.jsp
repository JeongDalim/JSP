...
<c:if test="${empty list }">
        ...
        <font face="돋움" size="2" color="#000000" colspan="5">
		       ${guest.subject }</td>
</c:if>
...
<c:forEach var="guest" items="${list}">
        ...
        <font face="돋움" size="2" color="#000000">
		     <a  class="list" href="guest_view.do?idx=${guest.idx}">${guest.subject }</a></td>
        <td align="center" height="20"><font face="돋움" size="2">
        <a class="list" href="mailto:ein1027@nate.com">${guest.name }</a></font></td>
        <td align="center" height="20"><font face="돋움" size="2">${guest.indate.substring(0,10)}</font></td>
        ...
        <table width="700" border="0" cellspacing="0" cellpadding="5">
          <tr>&nbsp;</tr><tr>
			...
			<tr align=right><td colspan="5">
				<a href="guest_write.do"><img src="./img/write.gif" border="0"></a>
			</td>
			</tr>
		</table>
		</div>
