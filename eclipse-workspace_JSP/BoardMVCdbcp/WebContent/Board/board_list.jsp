					...
					<tr>
						<td colspan="7" align="center" valign="center" height="20"><font
							size="4" face="돋움" color="blue"> <img
								src="Board/img/bullet-01.gif"> <b>자 유 게 시 판</b></font></td>
					</tr>
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : <b>${totcount }</b>건 - ${nowpage }
								/ ${totpage } Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
						...
						<c:forEach var="board" items="${list }">
							<tr onMouseOver="style.backgroundColor='#D1EEEE'"
								...
								<td align="center" height="25"><font face="돋움" size="2"
									color="#000000">${board.num }</font></td>
								<td align="left" height="20">&nbsp; <font face="돋움"
									size="2" color="#000000"> <a class="list"
										href="BoardServlet?cmd=board_view&num=${board.num }&page=${nowpage}">${board.subject }</a></td>
								<td align="center" height="20"><font face="돋움" size="2">
										<a class="list" href="mailto:ein1027@nate.com">${board.name }</a>
								</font></td>
								<td align="center" height="20"><font face="돋움" size="2">${board.indate }</font></td>
								<td align="center" height="20"><font face="돋움" size="2">
									...
									<form name="my" method="post" action="BoardServlet">
										...
										<table>
											...
											<tr>
												...
												<td><a href="javascript:sea()"><img
														src="Board/img/search2.gif" border="0"></a></td>
											</tr>
										</table>
									</form>
								</td>
								<td width="25%" align="right"><a
									href="BoardServlet?cmd=board_write&page=${nowpage }"><img
										src="Board/img/write.gif" border="0"></a></td>
							</tr>
						</table>
</body>
</html>
