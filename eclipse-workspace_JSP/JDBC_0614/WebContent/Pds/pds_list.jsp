...
<c:if test="${empty list}">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        <td align="center" height="20" colspan="6">등록된 글이 없습니다.</td>
...
<c:if test="${!empty list}">
<c:set var="bunho" value="${list.size()}"/>
<c:forEach var="bean" items="${list}">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        <td align="center" height="25">
        <font face="돋움" size="2" color="#000000">${bunho }</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="view.do?num=${bean.num }">${bean.subject }</a></font></td>
        <td align="center" height="20"><font face="돋움" size="2">${bean.filename }</td>
				<td align="left" height="20"><font face="돋움" size="2">${bean.name }</font></td>
				<td align="left" height="20"><font face="돋움" size="2">${bean.indate.substring(0,10) }</font></td>
				<td align="center" height="20"><font face="돋움" size="2">${bean.readcnt}</font></td> 	      
			</tr> 
<c:set var="bunho" value="${bunho-1}"></c:set>			
   ...
   <tr>
      <td colspan="7" align="right">
			<a href="write.do"><img src="./img/write.gif" alt="자료등록" align="middle" border="0"></a>
      &nbsp;
	  </td>
   </tr>
