		...
		<table border="0" width="800">
			<tr>
				...
				<td width="80%" valign="top">&nbsp;<br> <img
					...
					color="blue"> <b> 뮤직자료실</b></font><font size="2"> - 자료 수정하기</font>
					<p>
					...
					<table border="0">
						...
						<tr>
							...
							<td><input type="button" value="수정하기" onClick="pass_check()">&nbsp;
