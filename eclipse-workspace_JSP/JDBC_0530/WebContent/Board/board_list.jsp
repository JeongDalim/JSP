...
<%@ page import="java.util.*,Jdbc_0530_Board_Bean.*"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%
	BoardManager manager = BoardManager.getInstance();
	List<BoardBean> list = manager.list();
				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : <b>${list.size() }</b>건 - 1/ 2
								Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<c:if test="${list.size()==0 }">
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<td align="left" height="20">&nbsp; <font face="돋움" size="2"
								color="#000000"> <a class="list" href="">등록된 자료가
										없습니다.</a></td>
							<td align="center" height="20"><font face="돋움" size="2">
									<a class="list" href="mailto:ein1027@nate.com"></a>
							</font></td>
							...
							<tr onMouseOver="style.backgroundColor='#D1EEEE'"
								...
								<td align="left" height="20">&nbsp; <font face="돋움"
									size="2" color="#000000"> <a class="list"
										href="board_view.jsp?num=${board.num }">${board.subject }</a></td>
								<td align="center" height="20"><font face="돋움" size="2">
										<a class="list" href="mailto:ein1027@nate.com">${board.name }</a>
								</font></td>
								<td align="center" height="20"><font face="돋움" size="2">${board.indate.substring(0,10) }</font></td>
								<td align="center" height="20"><font face="돋움" size="2">
